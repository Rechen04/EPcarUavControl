...
nav_point = [
    # [0,0,0],
    # [2.15,0.8,1.571],[3.65,0.75,1.571],[4.9,0.88,1.571],[5.93,0.92,1.571],
    # [7.45,0.9,1.571],[7.45,2.55,1.571], #1.76
    # [5.9,2.98,1.571],[4.9,2.95,1.571],[3.65,2.81,1.571],[2.15,2.85,1.571],
    # [0,0,1.571]
        ]
...
if __name__ == '__main__':
    ...
    rw.write_car_data("/home/tta/list_of_goods.xls",task_result_end)
    rw.data_save("/home/tta/list_of_goods")

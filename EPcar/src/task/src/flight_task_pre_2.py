...
nav_point = [
    [0.04,0.48,0,0,4000,1],[0,0.37,0,0,4000,1],[0.04,0.30,0,0.5,4000,1],[0,0.25,0,0,4000,1],
    [0,0.33,0,0,4000,0],[0.54,0,0,0,4000,0],
    # [0,0,0,0,0,2]
    [0.06,-0.28,0,0,4000,1],[0,-0.25,0,0,4000,1],[-0.03,-0.28,0,0.5,4000,1],[0,-0.34,0,0,4000,1],
...
if __name__ == '__main__':
    ...
    for point in nav_point:
        ...
        if nav_state and point[5]==1:
            ...
            rw.write_air_data("/home/tta/list_of_goods_2.xls",task_result_end)

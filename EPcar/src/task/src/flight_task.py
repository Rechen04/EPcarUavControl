...
nav_point = [
    # [0.12,0.46,-0.08,0.5,4000,1],[0,0.37,0,0,4000,1],[0.04,0.30,0,0.5,4000,1],[0,0.25,0,0,4000,1],
    # [0,0.33,0,0,4000,0],[0.46,0,0,0,4000,2],
    [0,0,0,0,0,2]
    # [0.06,-0.28,-0.09,0.5,4000,1],[0,-0.25,0,0,4000,1],[-0.03,-0.28,-0.01,0,4000,1],[0,-0.34,0,0,4000,1],
    # [0,-0.48,0,0,4000,0],[-0.3,0,0,0,7500,2]
        ]
        ...
        if nav_state and point[5]==1:
            ...
            if landing_state == 2:
                ...
                if Final:
                    ...
                    rw.write_air_data("/home/tta/list_of_goods.xls",task_result_end,cls="fin")
                    rw.data_save("/home/tta/list_of_goods")
                    ...
                    rospy.loginfo(f"\nTask result_end: {task_result_end}")
                    rw.write_air_data("/home/tta/list_of_goods.xls",task_result_end)
                    rw.data_save("/home/tta/list_of_goods")
                    rospy.loginfo(f"xl written.")
            ...
            while location_x < 456 or location_x > 516 or location_y < 470 or location_y > 530:
                ...
                # while (location_x<486 and location_x>466) or (location_x>501 and location_x<506) or (location_y<490 and location_y>480) or (location_y>510 and location_y<520):
                #     if location_x < 486 and location_y < 490:
                #         nav_to_goal(nav_uint_x_min,1)
                #         nav_to_goal(nav_uint_y_min,1)
                #     elif location_x < 486 and location_y > 510:
                #         nav_to_goal(nav_uint_x_min,1)
                #         nav_to_goal(nav_uint__y_min,1)
                #     elif location_x > 501 and location_y < 490:
                #         nav_to_goal(nav_uint__x_min,1)
                #         nav_to_goal(nav_uint_y_min,1)
                #     elif location_x > 501 and location_y > 510:
                #         nav_to_goal(nav_uint__x_min,1)
                #         nav_to_goal(nav_uint__y_min,1)
                #     elif location_x < 486 and location_y < 510 and location_y > 490:
                #         nav_to_goal(nav_uint_x_min,1)
                #     elif location_x > 501 and location_y < 510 and location_y > 490:
                #         nav_to_goal(nav_uint__x_min,1)
                #     elif location_y < 490 and location_x < 501 and location_x > 486:
                #         nav_to_goal(nav_uint_y,1)
                #     elif location_y > 510 and location_x < 501 and location_x > 486:
                #         nav_to_goal(nav_uint__y_min,1)
                #     else:
                #         pass
                #     detect_state = photo_and_yolo_flight("photo_charge")
